...
> workshop. The journals, organisations, people, identifiers, and record numbers do not exist. Do
> not cite anything in this folder, inside the workshop or outside it.

## Why this folder exists

Checking a citation normally means leaving your working folder: resolving an identifier, searching a
discovery layer, opening a landing page. Nobody in this workshop has web search, and a live lookup
...
record matches the citation that pointed at it, whether the source can carry the claim attached to
it, or what to record about it. That is the work.

Read the record before you read the claim it is attached to. Then go back to the scan.
...
read, and a platform that refused the request are four different things, and they license four
