...
steps:
  ...
  - index: 7
    ...
    type: "reflect"
    instruction: "You ran a test nobody else in the cohort ran on your configuration, and the interesting part is comparing it. Record your result here — it is the one thing in this module that is worth pooling, and your facilitator can read what you write."
