---
id: "01-orient"
title: "Open the Scan and Choose the Review Approach"
...
steps:
  ...
  - index: 4
    ...
    type: "reflect"
    instruction: "Citations make verification possible. They are not verification themselves - a source table is not the same as a checked source table."
  ...
  - index: 5
    ...
    type: "reflect"
    instruction: "This is the question that matters locally, and it keeps coming up throughout the module. Answer it here for the record, or bring it to office hours - it is worth discussing with a colleague."
    reflection_prompt: "Who in your library would actually be asked to check a report like this, and with what time?"
---

## Open the Scan and Choose the Review Approach
