...
steps:
  - index: 0
    ...
    type: "workspace"
    instruction: |
      You will be installing a plugin and then working with it. You can complete this module in either of two environments.
  ...
  - index: 2
    ...
    type: "prompt"
    instruction: "Now find out exactly what you installed. Ask what the marketplace and plugin add, what they can access, and which claims you still need to trust."
    prompt_text: |
...
The important difference is between adding something useful and knowing exactly what it does. That distinction is the focus of this module.

The `kanon` skill is a guide to the tool. It includes six references - an authoring guide, a command reference, a twenty-lesson tutorial, a self-paced course, a curriculum guide for library staff, and an optional semantic-search practice. You will use two of them in this module; the list shows what other help is available later.
