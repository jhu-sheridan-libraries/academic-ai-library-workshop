...
description: Plan, facilitate, and debrief a live Research with AI workshop for a cohort of research librarians. Use when an instructor asks for a run of show, time-boxed agenda, workshop preflight, product-neutral demonstration, discussion prompts, pacing help, dashboard interpretation, accessibility or no-premium alternatives, or an end-of-session debrief for the bundled Library AI Workshop.
---
